...
case 'GET': 
            ...
            {
            $sql = $db->query("SELECT *,DATE_FORMAT(girisTarihi, '%d.%m.%Y') AS formattedStartDate,DATE_FORMAT(cikisTarihi, '%d.%m.%Y') AS formattedEndDate FROM rezervasyonlar  ")->fetchAll(PDO::FETCH_OBJ);
