    <div id="left-sidebar" class="sidebar">
        <div class="sidebar-scroll">
            <div class="user-account">
                <img src="/img/logo.png" class="xrounded-circle user-photox" alt="User Profile Picture" style="width:200px">
                <!-- <div class="dropdown">
                    <span >Hosgeldiniz,</span>
                    <a href="javascript:void(0);" class="dropdown-toggle user-name" data-toggle="dropdown" ><strong id="user">{user}</strong></a>
                    <ul class="dropdown-menu dropdown-menu-right account">
                        <li><a href="page-profile2.html"><i class="icon-user"></i>Profilim</a></li>
                        <li><a href="app-inbox.html"><i class="icon-envelope-open"></i>Mesajlar</a></li>
                        <li><a href="javascript:void(0);"><i class="icon-settings"></i>Ayarlar</a></li>
                        <li class="divider"></li>
                        <li><a href="page-login.html"><i class="icon-power"></i>Çılış</a></li>
                    </ul>
                </div> -->
                <hr>
                <!-- <ul class="row list-unstyled">
                    <li class="col-4">
                        <small>Satışlar</small>
                        <h6>456</h6>
                    </li>
                    <li class="col-4">
            ...
            <ul class="nav nav-tabs">
                <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#menu">Menü</a></li>
                ...
                <div class="tab-pane active" id="menu">
                    <nav id="left-sidebar-nav" class="sidebar-nav">
                        <ul id="main-menu" class="metismenu">                            
                            <li class="active">
                                <a href="#Dashboard" class="has-arrow"><i class="icon-home"></i> <span>Anasayfa</span></a>
                                <ul>
                                    <li><a href="javascript:void(0);" onclick="loadPage('urunler');">Odalar</a></li>
                                    <li><a href="javascript:void(0);" onclick="loadPage('rezervasyonlar');">Rezervasyonlar</a></li>
                                    <!-- <li><a href="javascript:void(0);" onclick="loadPage('kategori');">Dönemler</a></li> -->
                                </ul>
                            </li>
                            <!-- <li>
                                <a href="#App" class="has-arrow"><i class="icon-grid"></i> <span>Finans Yönetimi</span></a>
                                <ul>
